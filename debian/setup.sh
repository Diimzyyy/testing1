...
#install ssh ovpn
wget https://raw.githubusercontent.com/dimasmrnzl/testing1/main/debian/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
...
echo -e "                   Rebuild By : DIMZY SSH                 #" | tee -a log-install.txt
echo -e "#                   Contact    : facebook.com/gimpiels    #" | tee -a log-install.txt
echo -e "#                     Whatsapp   : 081335927230                     #" | tee -a log-install.txt
echo -e "          =================================================" | tee -a log-install.txt
echo "========================-[  BY SSH DIMZY   ]-==========================" | tee -a log-install.txt
echo ""
echo " Reboot 10 Sec"
sleep 10
rm -f setup.sh
