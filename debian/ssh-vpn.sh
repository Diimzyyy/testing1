...
[Unit]
Description=Python Edu Ovpn By SSH DIMZY
...
[Unit]
Description=Python Edu Ovpn By DIMZY
Documentation=https://google.com/
After=network.target nss-lookup.target
...
[Unit]
Description=Python Edu Ssl Proxy By DIMZY
Documentation=https://google.com/
After=network.target nss-lookup.target
...
echo "echo Script Premium By SSH DIMZY" >> .profile
echo "echo Contact : wa.me/6281335927230" >> .profile
...
echo "<h1><center>AutoScript</center></h1>" > /home/vps/public_html/index.html
